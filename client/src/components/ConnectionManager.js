                    ...
                    {connections.length > 0 ? (
                        <div className="space-y-3">
                            ...
                            <div className="flex gap-2">
                                ...
                                {connections.find(c => c.connectionId === activeConnectionId)?.status === 'logged out' && (
                                    <button
                                        onClick={() => onReinitConnection(activeConnectionId)}
                                        className="ml-2 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-amber-600 hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
                                    >
                                        <QrCode className="w-4 h-4 mr-2" /> Reinit
                                    </button>
                                )}
                            </div>
                        </div>
